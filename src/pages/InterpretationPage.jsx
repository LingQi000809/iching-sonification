...
import hexagramImg from "../assets/hexagram.jpg";
...
const tooltipText = (
  <div className="w-full h-full flex flex-col items-center p-10 space-y-6">
      ...
      <h2 className="text-2xl font-semibold text-black/80 font-serif tracking-wide">
        Interpretation of Hexagrams / 卦辞解读
      </h2>
      <p className="text-m leading-relaxed text-black/70">
        After the casting process, the oracle provides an interpretation of the
        hexagrams based on your question and the original and derived hexagrams. 
        I-Ching provides an interpretation for each hexagram and changing line.
        The specific interpretation presented here is generated using
        advanced language models (Gemini) to offer insights into the meanings of the
        hexagrams and their relevance to your inquiry.
      </p>
            <h2 className="text-2xl font-semibold text-black/80 font-serif tracking-wide">
        Music Generation / 音乐生成
      </h2>
      <p className="text-m leading-relaxed text-black/70">
        The soundscape you hear is generated by Lyria, an AI music system that
        composes music in real-time based on textual prompts. The prompts are
        derived from your question and the hexagrams cast during the divination
        process. Lyria interprets these prompts to create a unique auditory
        experience that reflects the themes and energies of your inquiry and the
        I-Ching wisdom.

        Click on "Lyria Prompt JSON" button in the interpretation panel to view
        the exact prompt sent to Lyria for music generation.
      </p>
      <img
          src={hexagramImg}
          alt="Hexagram Illustration"
          className="w-full h-auto max-w-none"
          caption="Hexagram Illustration / 卦象图示"
        />
